...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMColorGradingShaker : MonoBehaviour
    {
        ...
        protected ColorAdjustments _colorGrading;
        ...
        protected virtual void Awake()
        {
            ...
            _initialPostExposure = _colorGrading.postExposure.value;
            _initialHueShift = _colorGrading.hueShift.value;
            _initialSaturation = _colorGrading.saturation.value;
            _initialContrast = _colorGrading.contrast.value;
            Shaking = false;
        }
        ...
        protected virtual void Shake()
        {
            ...
            if (RelativeIntensity) { _colorGrading.postExposure.Override(_colorGrading.postExposure.value + _initialPostExposure); }
            if (RelativeIntensity) { _colorGrading.hueShift.Override(_colorGrading.hueShift.value + _initialHueShift); }
            if (RelativeIntensity) { _colorGrading.saturation.Override(_colorGrading.saturation.value + _initialSaturation); }
            if (RelativeIntensity) { _colorGrading.contrast.Override(_colorGrading.contrast.value + _initialContrast); }
        }
