...
public struct Char_CapsuleSnapshotData : ISnapshotData<Char_CapsuleSnapshotData>
{
    public uint tick;
    ...
    public void Deserialize(uint tick, ref Char_CapsuleSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref Char_CapsuleSnapshotData target, float factor)
    {
