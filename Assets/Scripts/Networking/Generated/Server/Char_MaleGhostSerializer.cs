...
public struct Char_BanditGhostSerializer : IGhostSerializer<Char_BanditSnapshotData>
{
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<Char_BanditSnapshotData>();
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref Char_BanditSnapshotData snapshot, GhostSerializerState serializerState)
    {
        snapshot.tick = tick;
