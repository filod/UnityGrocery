...
public struct platformGhostSerializer : IGhostSerializer<platformSnapshotData>
{
    private ComponentType componentTypePlatformMotion;
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<platformSnapshotData>();
    public void BeginSerialize(ComponentSystemBase system)
    {
        componentTypePlatformMotion = ComponentType.ReadWrite<PlatformMotion>();
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref platformSnapshotData snapshot, GhostSerializerState serializerState)
    {
        snapshot.tick = tick;
    }
}
