...
public class platformGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<platformSnapshotData> ghostSnapshotDataType;
...
#endif
                platformSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<platformSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<platformSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
                ComponentType.ReadOnly<PredictedGhostComponent>(),
            }
        });
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<platformSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<platformSnapshotData>(true),
...
public partial class platformGhostSpawnSystem : DefaultGhostSpawnSystem<platformSnapshotData>
{
}
