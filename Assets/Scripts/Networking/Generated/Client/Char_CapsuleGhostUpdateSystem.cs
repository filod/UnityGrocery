...
public class Char_CapsuleGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<Char_CapsuleSnapshotData> ghostSnapshotDataType;
...
#endif
                Char_CapsuleSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<Char_CapsuleSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<Char_CapsuleSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<Char_CapsuleSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<Char_CapsuleSnapshotData>(true),
...
public partial class Char_CapsuleGhostSpawnSystem : DefaultGhostSpawnSystem<Char_CapsuleSnapshotData>
{
    struct SetPredictedDefault : IJobParallelFor
    {
        [ReadOnly] public NativeArray<Char_CapsuleSnapshotData> snapshots;
    ...
    protected override JobHandle SetPredictedGhostDefaults(NativeArray<Char_CapsuleSnapshotData> snapshots, NativeArray<int> predictionMask, JobHandle inputDeps)
    {
